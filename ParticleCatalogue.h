...
public:
  ParticleCatalogue() {
    ...
    addTo(pi);
    Meson K =  Meson(321,   493.677, 155.6, MesonType::pseudoscalar, Charge::charged);
    addTo(K);
    ...
    Meson pi0 =  Meson(111,  134.9766, 130.2, MesonType::pseudoscalar, Charge::neutral);
    addTo(pi0);
    ...
    addTo(rho);
    Meson Dstar =  Meson(413,  2010.26, 535000, MesonType::vector, Charge::charged);
    addTo(Dstar);
    Meson Dstars =  Meson(431,  2112.1, 650000, MesonType::vector, Charge::charged);
    addTo(Dstars);
    ...
    addTo(rho0);
    Meson omega =  Meson(223,  782.65, 153000, MesonType::vector, Charge::neutral);
    omega.insertValue("kh", 4./3.*weinberg);
    addTo(omega);
    Meson phi =  Meson(333,  1019.461, 234000, MesonType::vector, Charge::neutral);
    phi.insertValue("kh", (4./3.*weinberg)-1.);
    addTo(phi);
    Meson jpsi =  Meson(443,  3096.916, 1290000, MesonType::vector, Charge::neutral);
    jpsi.insertValue("kh", 1.-8./3.*weinberg);
    addTo(jpsi);
  }

  Meson getMeson(Int_t p) const {
    return mesons.at(p);
  }
  ...
  Lepton getLepton(Int_t p) const {
    return leptons.at(p);
  }
