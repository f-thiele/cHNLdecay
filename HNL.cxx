...
Double_t HNL::getPartialWidth(std::shared_ptr<Config> cfg, const Lepton &alpha, const Lepton &beta, bool invisible) const {
  Double_t dw = 0;
...
Double_t HNL::getPartialWidthInv(std::shared_ptr<Config> cfg, const Lepton &alpha, const Lepton &beta) const {
  return std::max(0., pw_nualpha_nubeta_nubeta(cfg, alpha, beta, *this));
}


Double_t HNL::getPartialWidth(std::shared_ptr<Config> cfg, const Lepton &alpha, const Meson &m) const {
  Double_t dw = 0;
